...
export async function resetPassword(email, token, validation, password, success, error) {
    const {data, error: err} = await UserActions.resetUserPassword(email, token, validation, password)(dispatch, getState);
    if (data) {
